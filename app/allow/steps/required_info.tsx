                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {!selectStampLoading && !availableStampUserDappPerms.includes(relevant_stamp?.id) && (
                          <div className="flex items-center space-x-2">
                            ...
                            }} className="px-3 py-2 text-[10px] font-bold text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              Add Stamp Perm
                            </button>
