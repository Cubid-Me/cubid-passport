...
export const Stamps = ({ stampsToAdd, fetchAllStamps }: any) => {
      ...
      if (_ === "instagram") {
        stampsToRender.push(
          <Card>
            ...
            <CardContent>
              {Boolean((stampsWithId as any)['instagram']) ? (
        ...
        stampsToRender.push(
          ...
          <CardHeader>
            ...
            {doesStampExist((stampsWithId as any)[supabaseData.supabase_key]) ? (
              <CardDescription>
          ...
          <CardContent>
            {doesStampExist((stampsWithId as any)[supabaseData.supabase_key]) ? (
              ...
              <Button
                onClick={() => {
                  signInWithSocial((stampsWithId as any)[supabaseData.supabase_key])
                }}
                variant="outline"
              >
                Connect Account
