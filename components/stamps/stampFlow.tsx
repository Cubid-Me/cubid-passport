...
export const StampFlow = ({ stampsToAdd, fetchAllStamps }: any) => {
      ...
      stampsToRender.push(
        <Card style={{ height: "auto" }}>
          <CardHeader>
            ...
            {(userState as any)?.[supabaseData.local_key] ? (
              <CardDescription>
              ...
              <CardDescription>
                Connect your existing {supabaseData.supabase_key} to verify
              </CardDescription>
            )}
          </CardHeader>
          <CardContent>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        deleteStamp(supabaseData?.local_key)
                      }}
                      style={{ color: "red" }}
                    >
                      Remove Stamp
